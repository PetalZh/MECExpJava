...
public class Constants {
	  public static final double DELAY_THRESH = 25; // total delay threshold
	  ...
	  public static final double ALPHA = 0.8; // noise-distance coefficient
	  public static final int BANDWIDTH = 200; // bandwidth
	  public static final int CANNEL_SIGNAL_POWER = 32; // channel signal power
